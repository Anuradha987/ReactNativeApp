...
useEffect(() => {
  console.log("New req form");
    ...
    // ServicesService.AddService(dataObj).then((res)=>{
    //   console.log(res.data);
      ...
      ListHeaderComponent={
        ...
        <TextInput
            ...
            >sssssssssssss
              ...
              <TouchableOpacity
                style={styles.selectToWhomeIconArea}
                onPress={() => {}}
              >
                <EntypoIcon
                  name="chevron-small-down"
                  style={styles.selectToWhomeIcon}
                ></EntypoIcon>
              </TouchableOpacity>
            </View>
            ...
            >
              ...
              {data.isValidTitle ? null : (
                <Text style={styles.errMsg}>Enter the Title</Text>
              )}
            </View>
            <TextInput
              placeholder=""
            ...
            <View style={styles.categorytxt}>
              ...
              <TouchableOpacity
                style={styles.selectCategoryIconArea}
                onPress={() => {}}
              >
                <EntypoIcon
                  name="chevron-small-down"
            ...
            <View style={styles.priorityRadioBtnRow}>
              <MaterialRadio
                data={dummyData.priorityCategory}
                style={{ marginRight: 0 }}
